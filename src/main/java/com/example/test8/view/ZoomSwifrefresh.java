package com.example.test8.view;
 ...
 * </p>
 */
public class ZoomSwifrefresh extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = ZoomSwifrefresh.class.getSimpleName();
     ...
     * @param context
     */
    public ZoomSwifrefresh(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public ZoomSwifrefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                     (width / 2 + circleWidth / 2), childHeight/2 + circleHeight);
    ...
    /**
     * Set a callback to override {@link ZoomSwifrefresh#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link ZoomSwifrefresh#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link ZoomSwifrefresh#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(ZoomSwifrefresh parent, @Nullable View child);
    }
}
